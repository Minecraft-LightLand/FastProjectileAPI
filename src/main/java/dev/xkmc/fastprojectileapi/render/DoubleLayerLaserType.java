...
import dev.xkmc.fastprojectileapi.init.FPConfig;
...
public record DoubleLayerLaserType(ResourceLocation inner, ResourceLocation outer, int color)
	...
	public void start(MultiBufferSource buffer, Iterable<Ins> list) {
		boolean ADDITIVE = FPConfig.CLIENT.laserRenderAdditive.get();
		boolean INVERT = FPConfig.CLIENT.laserRenderInverted.get();
		double tran = FPConfig.CLIENT.laserTransparency.get();
